 ...
 */
class WC_Leaselink_Plugin_PL_Helper {
	...
	public static function get_notification_url() {
		...
		return add_query_arg( 'wc-api', 'WC_Gateway_Leaselink_Plugin_PL_Paynow', home_url( '/' ) );
	}
	...
	public static function is_paynow_order( $order ): bool {
		...
		return strpos( $payment_method, WC_LEASELINK_PLUGIN_PREFIX ) !== false;
	}
