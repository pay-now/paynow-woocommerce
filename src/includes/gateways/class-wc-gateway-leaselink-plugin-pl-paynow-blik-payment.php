...
class WC_Gateway_Leaselink_Plugin_PL_Paynow_Blik_Payment extends WC_Gateway_Leaselink_Plugin_PL_Paynow {

	public const BLIK_CONFIRM_TEMPLATE_NAME = 'confirm_blik_payment';

	public function __construct() {
		$this->id                 = WC_LEASELINK_PLUGIN_PREFIX . 'blik';
	...
	public function payment_fields() {
		...
		if ( $blik_payment_methods && $this->isWhiteLabelEnabled( $blik_payment_methods ) ) {
			...
			include WC_LEASELINK_PLUGIN_FILE_PATH . WC_LEASELINK_PLUGIN_TEMPLATES_PATH . 'blik_payment.php';
		} else {
