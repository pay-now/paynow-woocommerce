...
/**
 * Class WC_Gateway_Leaselink_Plugin_PL_Paynow_Remove_Instrument_Handler
 */
class WC_Gateway_Leaselink_Plugin_PL_Paynow_Remove_Instrument_Handler extends WC_Gateway_Leaselink_Plugin_PL_Paynow {
	...
	public function remove_instrument( string $instrument ): WP_REST_Response {
		...
		try {
			...
			$response['error'] = __( 'An error occurred while deleting the saved card.', 'leaselink-plugin-pl' );
