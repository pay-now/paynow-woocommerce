...
class WC_Leaselink_Plugin_PL_Locking_Mechanism {

	const LOCKS_DIR    = 'leaselink-locks';
	const LOCKS_PREFIX = 'leaselink-lock-';
	...
	/**
	 * Constructor of WC_Leaselink_Plugin_PL_Locking_Mechanism
	 */
	public function __construct() {
		...
		if ( ! is_writable( $this->locks_dir_path ) ) {
			WC_Leaselink_Plugin_PL_Logger::error( 'Locking mechanism disabled, no locks path available.' );
		}
