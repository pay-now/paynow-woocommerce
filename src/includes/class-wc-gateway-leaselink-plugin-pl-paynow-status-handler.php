...
/**
 * Class WC_Gateway_Leaselink_Plugin_PL_Paynow_Status_Handler
 */
class WC_Gateway_Leaselink_Plugin_PL_Paynow_Status_Handler extends WC_Gateway_Leaselink_Plugin_PL_Paynow {
