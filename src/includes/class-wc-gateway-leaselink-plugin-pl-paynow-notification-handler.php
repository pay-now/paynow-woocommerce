...
class WC_Gateway_Leaselink_Plugin_PL_Paynow_Notification_Handler extends WC_Gateway_Leaselink_Plugin_PL_Paynow {
	...
	public function handle_notification() {
		...
		$headers = WC_Leaselink_Plugin_PL_Helper::get_request_headers();
		...
		try {
			...
			$this->process_notification(
				$notification_data[ WC_Leaselink_Plugin_PL_Helper::NOTIFICATION_PAYMENT_ID_FIELD_NAME ],
				$notification_data[ WC_Leaselink_Plugin_PL_Helper::NOTIFICATION_STATUS_FIELD_NAME ],
				$notification_data[ WC_Leaselink_Plugin_PL_Helper::NOTIFICATION_EXTERNAL_ID_FIELD_NAME ],
				$notification_data[ WC_Leaselink_Plugin_PL_Helper::NOTIFICATION_MODIFIED_AT_FIELD_NAME ] ?? ''
			);
		...
		} catch ( WC_Leaselink_Plugin_Pl_Notification_Stop_Processing_Exception | WC_Leaselink_Plugin_Pl_Notification_Retry_Processing_Exception $exception ) {
			$response_code                          = ( $exception instanceof WC_Leaselink_Plugin_Pl_Notification_Stop_Processing_Exception ) ? 200 : 400;
...
new WC_Gateway_Leaselink_Plugin_PL_Paynow_Notification_Handler();
